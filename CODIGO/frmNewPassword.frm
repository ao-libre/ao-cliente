...
Private Sub imgAceptar_Click()
    If Text2.Text <> Text3.Text Then
        Call MsgBox(JsonLanguage.Item("VALIDACION_BAD_PASSWORD").Item("TEXTO").Item(0), vbCritical Or vbOKOnly Or vbApplicationModal Or vbDefaultButton1, "Cambiar Contraseña")
        Exit Sub
    End If
