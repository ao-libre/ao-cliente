Attribute VB_Name = "mDownloadFile"
...
Sub CopyURLToFile(ByVal URL As String, ByVal FileName As String)
    ...
    Call MsgBox("Se descargo correctamente el grabador de videos (ffmpeg - programa open source). Ya podes empezar a grabar el juego y subirlo a las redes sociales.")
    frmMain.btnGrabarVideo.Enabled = False
