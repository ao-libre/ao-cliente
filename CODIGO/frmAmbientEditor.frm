...
Private Sub Form_Load()
    With Me
        .Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(0)
        .Frame1.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(1)
        .Option1(0).Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(2)
        .Option1(1).Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(3)
        .Command7.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(4)
        .Frame3.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(5)
        .Label4.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(6)
        .Command8.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(7)
        .Command10.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(8)
        .Frame2.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(9)
        .Check1.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(10)
        .Label2.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(11)
        .Command9.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(12)
        .Check2.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(13)
        .Check3.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(14)
        .Command1.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(15)
        .Command2.Caption = JsonLanguage.Item("AMBIENT-EDITOR").Item(16)
    End With
End Sub
