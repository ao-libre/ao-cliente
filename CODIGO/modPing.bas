...
Private Declare Function gethostbyname _
                Lib "WSOCK32.DLL" (ByVal hostname As String) As Long
...
Private Declare Function IcmpSendEcho _
                Lib "icmp.dll" (ByVal IcmpHandle As Long, _
...
Public Function Ping(strAddress As String, _
    ...
    If lngAddress <> INADDR_NONE Then
        ...
        If lngPortHandle Then
            ...
            'ping it.
            Call IcmpSendEcho(lngPortHandle, lngAddress, strDataToSend, Len(strDataToSend), 0, ECHO, Len(ECHO), PING_TIMEOUT)
