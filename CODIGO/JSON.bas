...
Private Function parseObject(ByRef str As String, ByRef index As Long) As Dictionary
    ...
    If m_str(index) <> A_CURLY_BRACKET_OPEN Then
        m_parserrors = m_parserrors & "Objeto inválido en la posición " & index & " : " & mid$(str, index) & vbCrLf
        Exit Function
...
Private Function parseArray(ByRef str As String, ByRef index As Long) As Collection
    ...
    If mid$(str, index, 1) <> "[" Then
        m_parserrors = m_parserrors & "Array inválido en la posición " & index & " : " + mid$(str, index, 20) & vbCrLf
        Exit Function
    End If
...
Private Function parseBoolean(ByRef str As String, ByRef index As Long) As Boolean
    ...
    ElseIf mid$(str, index, 5) = "false" Then
        ...
        index = index + 5
    Else
        m_parserrors = m_parserrors & "Boolean inválido en la posición " & index & " : " & mid$(str, index) & vbCrLf
...
Private Function parseNull(ByRef str As String, ByRef index As Long)
    ...
    If mid$(str, index, 4) = "null" Then
        ...
        index = index + 4
    Else
        m_parserrors = m_parserrors & "Valor nulo inválido en la posición " & index & " : " & mid$(str, index) & vbCrLf
            ...
            Case A_DOUBLE_QUOTE
                ...
                If Not dquote Then
                    ...
                    If m_str(index) <> A_COLON Then
                        m_parserrors = m_parserrors & "Valor clave inválido en la posición " & index & " : " & parseKey & vbCrLf
                        Exit Do
...
Public Function GetRegionalSettings(ByVal regionalsetting As Long) As String
    ' Devuelve la configuración regional del sistema
...
'********************************************************************************************************
'                   FUNCIONES MISCELÁNEAS DE LA ANTERIOR VERSIÓN DEL MÓDULO
'********************************************************************************************************
